...
<head>
    ...
    <link rel="shortcut icon" href="Melda.png">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <li><a class="nav-link" href="{{ url('/acerca')}}">Sobre Nosotros</a></li>
                <li><a class="nav-link" href="{{ url('cursos')}}">Inscribirse</a></li>
                <li><a class="nav-link" href="{{ url('/alumnos')}}">Alumnos</a></li>
                <li><a class="nav-link" href="{{ url('/inscripciones')}}">Inscripciones</a></li>
                </ul>
              </li>
            </ul>
          </div>
